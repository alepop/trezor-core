...
from .RISETransactionAsset import RISETransactionAsset


class RISETransactionCommon(p.MessageType):
    ...
    def __init__(
        ...
        timestamp: int = None,
        asset: RISETransactionAsset = None,
    ) -> None:
        self.type = type
        self.amount = amount
        self.fee = fee
    ...
    def get_fields(cls):
        return {
            ...
            9: ('asset', RISETransactionAsset, 0),
        }
